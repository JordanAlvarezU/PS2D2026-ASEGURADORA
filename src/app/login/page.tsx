  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (code === 'auth/user-not-found' || code === 'auth/wrong-password' || code === 'auth/invalid-credential') {
        ...
        setError('Error al iniciar sesión. Verifica tu conexión e inténtalo de nuevo.')
      }
    } finally {
      setLoading(false)
    }
        ...
        <div className="w-full max-w-md">
          ...
          {showReset ? (
            <>
              ...
              {resetSuccess ? (
                <div className="bg-green-50 border border-green-200 text-green-700 rounded-2xl px-5 py-4 text-sm mb-6">
                  ✅ Correo enviado. Revisa tu bandeja de entrada (y la carpeta de spam) para restablecer tu contraseña.
                </div>
              ) : (
              ...
              <button
                ...
                className="mt-6 flex items-center justify-center gap-1 text-gray-mid text-xs hover:text-dark-green transition-colors w-full"
              >
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="block text-xs font-semibold text-dark-green/70 uppercase tracking-wide">
                      Contraseña
                    </label>
                    ...
                    <button
                      ...
                      className="text-xs text-orange hover:text-orange-hover font-medium transition-colors"
                    >
                      ¿Olvidaste tu contraseña?
                    </button>
                  </div>
