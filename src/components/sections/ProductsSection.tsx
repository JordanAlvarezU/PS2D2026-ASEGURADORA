...
export default function ProductsSection() {
  ...
  // Obtenemos solo los productos activos y tomamos los primeros 3 para destacarlos
  const featured = data?.productos.filter(p => p.activo).slice(0, 3) || []
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          {loading ? (
            // Skeletons de carga
            [...Array(3)].map((_, i) => (
              <div key={i} className="h-[450px] bg-white/50 animate-pulse rounded-3xl" />
            ))
